  ...
  return (
    <div className="inner">
      <div className="card guest__options">
        <div className={`button guest__option login ${loginShowing ? 'guest__option__active' : ''}`} onClick={() => toggleLoginShowing(true)}>
        ...
        <div className={`button guest__option register ${loginShowing ? '' : 'guest__option__active'}`} onClick={() => toggleLoginShowing(false)}>
